...
import io.swagger.codegen.v3.generators.AbstractCSharpCodegen;
...
public class CSharpUnityBestHttp2ClientCodegen extends AbstractCSharpCodegen {
    @SuppressWarnings({"hiding"})
    private static final Logger LOGGER = LoggerFactory.getLogger(CSharpUnityBestHttp2ClientCodegen.class);

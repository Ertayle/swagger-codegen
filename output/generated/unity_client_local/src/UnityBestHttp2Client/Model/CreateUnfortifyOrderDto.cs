...
{
    /// <summary>
    /// CreateUnfortifyOrderDto
    /// </summary>
    [DataContract]
        public partial class CreateUnfortifyOrderDto :  IEquatable<CreateUnfortifyOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateUnfortifyOrderDto" /> class.
        /// </summary>
        /// <param name=""> (required) (default to null).</param>
        /// <param name="">Starting or origin territory label (default to null).</param>
        public CreateUnfortifyOrderDto(OrderType  = null, String  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateUnfortifyOrderDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateUnfortifyOrderDto {\n");
        ...
        {
            return this.Equals(input as CreateUnfortifyOrderDto);
        }

        /// <summary>
        /// Returns true if CreateUnfortifyOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateUnfortifyOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateUnfortifyOrderDto input)
        {
            if (input == null)
                return false;

...
{
    /// <summary>
    /// CreateMoveStockOrderDto
    /// </summary>
    [DataContract]
        public partial class CreateMoveStockOrderDto :  IEquatable<CreateMoveStockOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMoveStockOrderDto" /> class.
        /// </summary>
        ...
        public CreateMoveStockOrderDto(OrderType  = null, String  = null, String  = null, Map  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateMoveStockOrderDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateMoveStockOrderDto {\n");
        ...
        {
            return this.Equals(input as CreateMoveStockOrderDto);
        }

        /// <summary>
        /// Returns true if CreateMoveStockOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateMoveStockOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateMoveStockOrderDto input)
        {
            if (input == null)
                return false;

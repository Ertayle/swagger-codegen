...
{
    /// <summary>
    /// CreateAerialProtectionOrderDto
    /// </summary>
    [DataContract]
        public partial class CreateAerialProtectionOrderDto :  IEquatable<CreateAerialProtectionOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAerialProtectionOrderDto" /> class.
        /// </summary>
        ...
        public CreateAerialProtectionOrderDto(OrderType  = null, String  = null, String  = null, Map  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateAerialProtectionOrderDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAerialProtectionOrderDto {\n");
        ...
        {
            return this.Equals(input as CreateAerialProtectionOrderDto);
        }

        /// <summary>
        /// Returns true if CreateAerialProtectionOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAerialProtectionOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAerialProtectionOrderDto input)
        {
            if (input == null)
                return false;

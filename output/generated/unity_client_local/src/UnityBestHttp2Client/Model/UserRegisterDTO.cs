...
namespace UnityBestHttp2Client.Model
{
        ...
        public partial class UserRegisterDTO :  IEquatable<UserRegisterDTO>
    {
        ...
        public UserRegisterDTO(String  = null, String  = null, String  = null, List  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for UserRegisterDTO and cannot be null");
            }
            else
            {
                this.email = ;

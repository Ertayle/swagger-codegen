...
namespace UnityBestHttp2Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WgConstructionModel :  IEquatable<WgConstructionModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WgConstructionModel" /> class.
        /// </summary>
        ...
        /// <param name="">Infra max population (default to null).</param>
        /// <param name="">Infra recipes (required) (default to null).</param>
        public WgConstructionModel(WgPriceModel  = null, WgPriceModel  = null, Integer  = null, Integer  = null, List  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for WgConstructionModel and cannot be null");
            }
            else
            {
                this.price = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WgConstructionModel {\n");
        ...
        {
            return this.Equals(input as WgConstructionModel);
        }

        /// <summary>
        /// Returns true if WgConstructionModel instances are equal
        /// </summary>
        /// <param name="input">Instance of WgConstructionModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WgConstructionModel input)
        {
            if (input == null)
                return false;

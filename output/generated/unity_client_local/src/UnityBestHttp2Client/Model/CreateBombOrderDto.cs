...
namespace UnityBestHttp2Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateBombOrderDto :  IEquatable<CreateBombOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBombOrderDto" /> class.
        /// </summary>
        ...
        public CreateBombOrderDto(OrderType  = null, String  = null, String  = null, Map  = null, AttackTargetType  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateBombOrderDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateBombOrderDto {\n");
        ...
        {
            return this.Equals(input as CreateBombOrderDto);
        }

        /// <summary>
        /// Returns true if CreateBombOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBombOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBombOrderDto input)
        {
            if (input == null)
                return false;

...
{
    /// <summary>
    /// CreateBuildConsOrderDto
    /// </summary>
    [DataContract]
        public partial class CreateBuildConsOrderDto :  IEquatable<CreateBuildConsOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBuildConsOrderDto" /> class.
        /// </summary>
        ...
        public CreateBuildConsOrderDto(OrderType  = null, String  = null, ConstructionType  = null, Integer  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateBuildConsOrderDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateBuildConsOrderDto {\n");
        ...
        {
            return this.Equals(input as CreateBuildConsOrderDto);
        }

        /// <summary>
        /// Returns true if CreateBuildConsOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBuildConsOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBuildConsOrderDto input)
        {
            if (input == null)
                return false;

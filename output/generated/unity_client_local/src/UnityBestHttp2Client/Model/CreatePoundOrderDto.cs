...
namespace UnityBestHttp2Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreatePoundOrderDto :  IEquatable<CreatePoundOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePoundOrderDto" /> class.
        /// </summary>
        ...
        public CreatePoundOrderDto(OrderType  = null, String  = null, String  = null, Map  = null, AttackTargetType  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreatePoundOrderDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreatePoundOrderDto {\n");
        ...
        {
            return this.Equals(input as CreatePoundOrderDto);
        }

        /// <summary>
        /// Returns true if CreatePoundOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreatePoundOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatePoundOrderDto input)
        {
            if (input == null)
                return false;

...
{
    /// <summary>
    /// CreateSetInfraTypeWgAdminDto
    /// </summary>
    [DataContract]
        public partial class CreateSetInfraTypeWgAdminDto :  IEquatable<CreateSetInfraTypeWgAdminDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSetInfraTypeWgAdminDto" /> class.
        /// </summary>
        ...
        public CreateSetInfraTypeWgAdminDto(WgAdminType  = null, String  = null, Integer  = null, InfraType  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateSetInfraTypeWgAdminDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSetInfraTypeWgAdminDto {\n");
        ...
        {
            return this.Equals(input as CreateSetInfraTypeWgAdminDto);
        }

        /// <summary>
        /// Returns true if CreateSetInfraTypeWgAdminDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSetInfraTypeWgAdminDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSetInfraTypeWgAdminDto input)
        {
            if (input == null)
                return false;

...
namespace UnityBestHttp2Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateSpyOrderDto :  IEquatable<CreateSpyOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSpyOrderDto" /> class.
        /// </summary>
        /// <param name=""> (required) (default to null).</param>
        /// <param name="">Target territory label (default to null).</param>
        public CreateSpyOrderDto(OrderType  = null, String  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateSpyOrderDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSpyOrderDto {\n");
        ...
        {
            return this.Equals(input as CreateSpyOrderDto);
        }

        /// <summary>
        /// Returns true if CreateSpyOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSpyOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSpyOrderDto input)
        {
            if (input == null)
                return false;

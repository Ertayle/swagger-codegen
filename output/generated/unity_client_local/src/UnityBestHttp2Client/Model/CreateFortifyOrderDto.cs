...
{
    /// <summary>
    /// CreateFortifyOrderDto
    /// </summary>
    [DataContract]
        public partial class CreateFortifyOrderDto :  IEquatable<CreateFortifyOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFortifyOrderDto" /> class.
        /// </summary>
        /// <param name=""> (required) (default to null).</param>
        /// <param name="">Starting or origin territory label (default to null).</param>
        public CreateFortifyOrderDto(OrderType  = null, String  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateFortifyOrderDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateFortifyOrderDto {\n");
        ...
        {
            return this.Equals(input as CreateFortifyOrderDto);
        }

        /// <summary>
        /// Returns true if CreateFortifyOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateFortifyOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateFortifyOrderDto input)
        {
            if (input == null)
                return false;

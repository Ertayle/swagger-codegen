...
{
    /// <summary>
    /// CreateDestroyInfraOrderDto
    /// </summary>
    [DataContract]
        public partial class CreateDestroyInfraOrderDto :  IEquatable<CreateDestroyInfraOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDestroyInfraOrderDto" /> class.
        /// </summary>
        ...
        public CreateDestroyInfraOrderDto(OrderType  = null, String  = null, Integer  = null, InfraType  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateDestroyInfraOrderDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateDestroyInfraOrderDto {\n");
        ...
        {
            return this.Equals(input as CreateDestroyInfraOrderDto);
        }

        /// <summary>
        /// Returns true if CreateDestroyInfraOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateDestroyInfraOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDestroyInfraOrderDto input)
        {
            if (input == null)
                return false;

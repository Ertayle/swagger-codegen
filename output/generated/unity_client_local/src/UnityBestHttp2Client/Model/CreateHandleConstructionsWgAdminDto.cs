...
{
    /// <summary>
    /// CreateHandleConstructionsWgAdminDto
    /// </summary>
    [DataContract]
        public partial class CreateHandleConstructionsWgAdminDto :  IEquatable<CreateHandleConstructionsWgAdminDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateHandleConstructionsWgAdminDto" /> class.
        /// </summary>
        ...
        public CreateHandleConstructionsWgAdminDto(WgAdminType  = null, String  = null, ConstructionType  = null, Integer  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateHandleConstructionsWgAdminDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateHandleConstructionsWgAdminDto {\n");
        ...
        {
            return this.Equals(input as CreateHandleConstructionsWgAdminDto);
        }

        /// <summary>
        /// Returns true if CreateHandleConstructionsWgAdminDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateHandleConstructionsWgAdminDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateHandleConstructionsWgAdminDto input)
        {
            if (input == null)
                return false;

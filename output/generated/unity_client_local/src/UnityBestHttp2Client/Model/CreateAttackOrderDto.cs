...
{
    /// <summary>
    /// CreateAttackOrderDto
    /// </summary>
    [DataContract]
        public partial class CreateAttackOrderDto :  IEquatable<CreateAttackOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAttackOrderDto" /> class.
        /// </summary>
        ...
        public CreateAttackOrderDto(OrderType  = null, String  = null, String  = null, Map  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for CreateAttackOrderDto and cannot be null");
            }
            else
            {
                this.type = ;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAttackOrderDto {\n");
        ...
        {
            return this.Equals(input as CreateAttackOrderDto);
        }

        /// <summary>
        /// Returns true if CreateAttackOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAttackOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAttackOrderDto input)
        {
            if (input == null)
                return false;

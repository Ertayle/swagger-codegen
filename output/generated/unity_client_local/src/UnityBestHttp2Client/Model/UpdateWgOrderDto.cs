...
namespace UnityBestHttp2Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateWgOrderDto :  IEquatable<UpdateWgOrderDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWgOrderDto" /> class.
        /// </summary>
        /// <param name="">Wargame id (default to null).</param>
        /// <param name="">Phase number for this order (default to null).</param>
        /// <param name="">Order consistant id (default to null).</param>
        /// <param name="">Order unique id (default to null).</param>
        ...
        /// <param name="">Can the user cancel the order ? (default to null).</param>
        /// <param name="">Phase where the order was created (default to null).</param>
        /// <param name="">Phase where the order will be resolved and closed (default to null).</param>
        ...
        public UpdateWgOrderDto(String  = null, Integer  = null, String  = null, String  = null, OrderStatus  = null, OrderType  = null, String  = null, Integer  = null, Boolean  = null, Integer  = null, Integer  = null, Map  = null, String  = null, String  = null, String  = null, String  = null, Map  = null, Map  = null, Integer  = null, InfraType  = null, ConstructionType  = null, AttackTargetType  = null, Integer  = null, )
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateWgOrderDto {\n");
        ...
        {
            return this.Equals(input as UpdateWgOrderDto);
        }

        /// <summary>
        /// Returns true if UpdateWgOrderDto instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateWgOrderDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateWgOrderDto input)
        {
            if (input == null)
                return false;

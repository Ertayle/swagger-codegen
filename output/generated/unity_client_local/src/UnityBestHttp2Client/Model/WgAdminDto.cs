...
namespace UnityBestHttp2Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WgAdminDto :  IEquatable<WgAdminDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WgAdminDto" /> class.
        /// </summary>
        /// <param name="">Wargame id (required) (default to null).</param>
        /// <param name="">Phase number for this wgAdmin (required) (default to null).</param>
        /// <param name="">WgAdmin unique id (required) (default to null).</param>
        ...
        public WgAdminDto(String  = null, Integer  = null, String  = null, WgAdminType  = null, String  = null, Integer  = null, String  = null, Map  = null, Map  = null, Map  = null, Integer  = null, InfraType  = null, ConstructionType  = null, Integer  = null, )
        {
            // to ensure "" is required (not null)
            if ( == null)
            {
                throw new InvalidDataException(" is a required property for WgAdminDto and cannot be null");
            }
            else
            {
                this.wgId = ;
        ...
        {
            return this.Equals(input as WgAdminDto);
        }

        /// <summary>
        /// Returns true if WgAdminDto instances are equal
        /// </summary>
        /// <param name="input">Instance of WgAdminDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WgAdminDto input)
        {
            if (input == null)
                return false;

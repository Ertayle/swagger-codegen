...
namespace UnityBestHttp2Client.Api
{
    ...
    /// </summary>
        public interface DefaultApi : IApiAccessor
    {
        ...
        ApiResponse<String> helloControllerHelloWithHttpInfo ();
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class DefaultApi : DefaultApi
    {
        ...
        /// <returns></returns>
        public DefaultApi(UnityBestHttp2Client.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="UnityBestHttp2Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>String</returns>
        public String helloControllerHello ()
        {
             ApiResponse<String> localVarResponse = helloControllerHelloWithHttpInfo();
        ...
        /// <exception cref="UnityBestHttp2Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of String</returns>
        public ApiResponse< String > helloControllerHelloWithHttpInfo ()
        {

            var localVarPath = "/v1/hello";
            ...
            {
                Exception exception = ExceptionFactory("helloControllerHello", localVarResponse);
